...
sequence_x,sequence_y = datasets.get_nid_sequence(train_data,10)
...
class NN(nn.Module):
    def __init__(self):
        ...
        #self.lstm_2 = BayesianLSTM(16, 1, prior_sigma_1=1, prior_pi=1, posterior_rho_init=-3.0)
...
net.load_state_dict(torch.load('best4.pt'))
