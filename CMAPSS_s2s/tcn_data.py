...
class NN(nn.Module):
    def __init__(self):
        ...
        self.tcn1 = TemporalConvNet(25, [32,16,8,4], kernel_size=2, dropout=0)
        self.tcn2 = TemporalConvNet(4, [8,4,2,1], kernel_size=2, dropout=0) #在时间维度上卷积
